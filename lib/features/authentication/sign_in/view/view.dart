            ...
            Container(
              child: Column(
                children: [
                  ...
                  CommonTextFormFiled(hintext: "example@gmail.com", icon: Icon(Icons.check_box_outlined),prefiex: Icon(Icons.email), hintText: '',),
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 20),
                    child: CommonTextFormFiled(hintext: "password", icon: Icon(Icons.remove_red_eye_outlined), hintText: '',),
                  ),
