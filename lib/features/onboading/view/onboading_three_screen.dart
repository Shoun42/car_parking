...
import 'package:car_parking/features/onboading/contollar/oboading_controller.dart';
            ...
            Row(
              children: [
                ...
                Expanded(child: InkWell(
                  onTap: ()=>controller.onboadingToLogInScreen(),
                  child: Container(
                    ...
                    height: 44.h,
                    child: Center(
                      child: Text("Get Stared",style: theme.bodyMedium,),
                    ),
                  ),
                ))
              ],
